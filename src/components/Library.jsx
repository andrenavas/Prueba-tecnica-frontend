...
//   const handleGenreChange = (event) => {
//     const selectedGenre = event.target.value;
//     console.log("Este es el género seleccionado antes de despachar la acción:", selectedGenre);
//     dispatch(setSelectedGenre(selectedGenre));
//     console.log("Despachada acción setSelectedGenre con género:", selectedGenre);
//   };
...
//     queryFn: getBooks,
//     onSuccess: (data) => {
//       console.log("Libros obtenidos de la API:", data.library);
//       dispatch(addBook(data.library)); // Guardar los libros en el estado Redux
//     },
//   });
